...
void TransformationSystem::handle(const double delta, std::unique_ptr<Entity> &entity)
{

  TransformComponent *component = entity->getComponents()->getComponent<TransformComponent>();
